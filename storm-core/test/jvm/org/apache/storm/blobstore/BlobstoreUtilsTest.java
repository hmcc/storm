...
public class BlobstoreUtilsTest {
     ...
     * (node.getPort is called by downloadUpdatedBlob)
     */
    @Test
    ...
    /**
     * If the node has children, their hostnames will be checked
     */
    @Test
